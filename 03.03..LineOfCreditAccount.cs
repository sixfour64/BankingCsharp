...
public InterestEarningAccount(string name, decimal initialBalance) : base(name, initialBalance)  // generates from base Class's constructor:  public BankAccount(string name, decimal initialBalance)
{
}
